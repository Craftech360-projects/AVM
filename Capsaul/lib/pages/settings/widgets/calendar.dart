...
class _CalendarPageState extends State<CalendarPage> {
  ...
  List<Widget> _calendarType() {
    return [
      RadioListTile(
        ...
        subtitle: const Text('Capsaul will auto-schedule your events.'),
        value: 'auto',
  ...
  List<Widget> _displayCalendars() {
    ...
    return [
      ...
      Text(
        'Select a calendar for Capsaul to connect to.',
        textAlign: TextAlign.center,
      ),
      h8,
        ...
        children: [
          ...
          if (!calendarEnabled)
            const Padding(
              ...
              child: Text(
                'Capsaul can auto-schedule events or ask for your confirmation first.',
                textAlign: TextAlign.center,
              ),
            ),
