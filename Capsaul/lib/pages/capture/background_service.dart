...
Future<void> initializeBackgroundService({bool isStream = false}) async {
  final service = FlutterBackgroundService();
  createNotification(
    title: 'Capsaul is listening in the background',
    body:
        'Capsaul is listening and transcribing your conversations in the background',
  );
    ...
    if (service is AndroidServiceInstance) {
      if (await service.isForegroundService()) {
        service.setForegroundNotificationInfo(
          title: 'Capsaul is running in background',
          content:
              'Capsaul is listening and transcribing your conversations in the background',
        );
      }
