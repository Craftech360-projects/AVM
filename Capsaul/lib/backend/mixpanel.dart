...
class MixpanelManager {
  ...
  setPeopleValues() {
    ...
    setUserProperty('Useful Memories Count',
        MemoryProvider().getNonDiscardedMemoriesCount());
  ...
  void onboardingStepICompleted(String step) =>
  ...
  void reProcessMemory(Memory memory) =>
