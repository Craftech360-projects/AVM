...
import 'package:capsaul/backend/api_requests/api/llm.dart';
...
import 'package:capsaul/utils/other/string_utils.dart';
...
Future<String> generateCapsaulReply(String transcript) async {
  var prompt = '''
