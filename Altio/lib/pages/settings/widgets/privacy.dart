      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'We take your privacy very seriously. We want to be transparent about the data we collect and how we use it to improve our product for you. Here\'s what you need to know:',
            ...
            h8,
            const Text(
              'We are committed to using the data we collect only to make Altio a better product for you. Your privacy and trust are paramount to us.',
              style: TextStyle(fontSize: 16),
            ),
            const SizedBox(height: 16),
            const Text(
              'Thank you for being a valued user of Altio. If you have any questions or concerns, feel free to reach out to us to www.craftech360.com.',
              style: TextStyle(fontSize: 16),
            ),
          ],
        ),
