...
class SharedPreferencesUtil {
  ...
  String get selectedModel => getString(_modelKey) ?? "llama-3.3-70b-versatile";
...
// Setter for isPromptSaved
  ...
  bool get useAltioApiKeys => getBool('useAltioApiKeys') ?? true;

  set useAltioApiKeys(bool value) => saveBool('useAltioApiKeys', value);
