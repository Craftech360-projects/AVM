...
import 'package:altio/utils/other/string_utils.dart';
...
Future<SummaryResult> summarizeMemory(
  ...
  var prompt = '''
I am your personal assistant, here to help you reflect on and summarize your conversations. Based on your latest discussion, I will extract key insights, highlight important topics, and provide useful takeaways in a second person perspective. Let's dive in!
...
''';
  ...
  // print("Structured Response in prompt: $structuredResponse");

  try {
    // Parse structuredResponse as JSON
    var parsedResponse = jsonDecode(structuredResponse);
    // print("parsedResponse in prompt: $parsedResponse");
    var structured = Structured.fromJson(parsedResponse);
    // print("structured in prompt: $structured");
...
Future<String> generateAltioReply(String transcript) async {
  var prompt = '''
...
Future<String> dailySummaryNotifications(List<Memory> memories) async {
  var msg =
      'There were no memories today, don\'t forget to wear your Capsaul tomorrow';
