...
#import "IBGTypes.h"
#import "IBGProactiveReportingConfigurations.h"
 ...
 */
@property(class, atomic, strong) void(^ _Nullable didDismissHandler)(IBGDismissType dismissType, IBGReportType reportType);
 ...
 */
@property(class, atomic, strong) void(^ _Nullable didSelectPromptOptionHandler)(IBGPromptOption promptOption);
...
+ (void)setCommentMinimumCharacterCountForReportTypes:(IBGBugReportingReportType)reportTypes
                                            withLimit:(NSInteger)limit DEPRECATED_MSG_ATTRIBUTE("Use [IBGBugReporting setCommentMinimumCharacterCount: forBugReportType: ]");
...
+ (void)setCommentMinimumCharacterCount:(NSInteger)count forBugReportType:(IBGBugReportingType)bugReportType;
...
+ (void)addUserConsentWithKey:(NSString *_Nullable)key
                  description:(NSString *_Nullable)description
                    mandatory:(BOOL)mandatory
                      checked:(BOOL)checked
                  actionType:(IBGActionType)actionType;
...
+ (void)setProactiveReportingConfigurations:(IBGProactiveReportingConfigurations * _Nonnull)configurations;
/*
 +------------------------------------------------------------------------+
 |                            Deprecated APIs                             |
 +------------------------------------------------------------------------+
