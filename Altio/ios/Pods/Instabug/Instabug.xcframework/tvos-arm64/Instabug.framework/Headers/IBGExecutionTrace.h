...
DEPRECATED_MSG_ATTRIBUTE("Please migrate to the App Flows APIs: APM.startFlow, APM.endFlow, and APM.setAttributeForFlow.")
NS_SWIFT_NAME(ExecutionTrace)
@interface IBGExecutionTrace : NSObject

/// Ends this instance of Execution Trace.
- (void)end DEPRECATED_MSG_ATTRIBUTE("Please migrate to the App Flows APIs: APM.startFlow, APM.endFlow, and APM.setAttributeForFlow.");
...
- (void)setAttributeWithKey:(NSString *)key value:(NSString *_Nullable)value DEPRECATED_MSG_ATTRIBUTE("Please migrate to the App Flows APIs: APM.startFlow, APM.endFlow, and APM.setAttributeForFlow.");
