...
extern NSString * const kIBGFrustratingExperienceStringName;
...
extern NSString * const kIBGProactiveReportingForceRestartAlertTitle;
extern NSString * const kIBGProactiveReportingForceRestartAlertMessage;
extern NSString * const kIBGProactiveReportingReportActionTitleName;
extern NSString * const kIBGProactiveReportingCancelActionTitleName;
...
extern NSString * const kIBGCommentFieldPlaceholderForFrustratingExperienceStringName;
...
extern NSString * const kIBGCommentFieldFrustratingExperienceAccessibilityStringHint;
...
extern NSString * const kIBGUserConsentRequired;
extern NSString * const kIBGUserConsentDefaultDescription;
 ...
 */
typedef NS_OPTIONS(NSInteger, IBGAutoMaskScreenshotOption) {
    IBGAutoMaskScreenshotOptionMaskNothing = 1 << 0,
    IBGAutoMaskScreenshotOptionTextInputs = 1 << 1,
    IBGAutoMaskScreenshotOptionLabels = 1 << 2,
    IBGAutoMaskScreenshotOptionMedia = 1 << 3,
};
...
typedef NS_OPTIONS(NSInteger, IBGBugReportingType) {
    IBGBugReportingTypeBug = 1 << 0,
    IBGBugReportingTypeFeedback = 1 << 1,
    IBGBugReportingTypeQuestion = 1 << 2,
    IBGBugReportingTypeFrustratingExperience = 1 << 3
...
typedef NS_ENUM(NSInteger, IBGReportType) {
    ...
    IBGReportTypeFrustratingExperience = 1 << 4
};
...
typedef NS_ENUM(NSInteger, IBGActionType) {
    IBGActionTypeDropAutoCapturedMedia = 1 << 0,
    IBGActionTypeDropLogs = 1 << 1,
    IBGActionTypeNoChat = 1 << 2,
};
...
typedef NS_ENUM(NSInteger, IBGInteractionViewType) {
    IBGInteractionViewTypeText,
    IBGInteractionViewTypeImage,
    IBGInteractionViewTypeButton,
    IBGInteractionViewTypeToggle,
    IBGInteractionViewTypeTextField,
    IBGInteractionViewTypeSecureField,
    IBGInteractionViewTypePicker,
    IBGInteractionViewTypeSlider,
    IBGInteractionViewTypeStepper,
    IBGInteractionViewTypeList,
    IBGInteractionViewTypeScrollView,
    IBGInteractionViewTypeVStack,
    IBGInteractionViewTypeHStack,
    IBGInteractionViewTypeZStack,
    IBGInteractionViewTypeTabView,
    IBGInteractionViewTypeSheet,
    IBGInteractionViewTypeAlert
};

/**
 Report issue type
 */
typedef NS_ENUM(NSInteger, IBGIssueType) {
    IBGIssueTypeBug,
    IBGIssueTypeCrash __attribute__((deprecated("Use IBGIssueTypeAllCrashes instead."))),
    IBGIssueTypeSessionReplay,
    IBGIssueTypeAll,
    IBGIssueTypeAllCrashes,
    IBGIssueTypeNonFatal,
    IBGIssueTypeFatal,
    IBGIssueTypeAppHang,
    IBGIssueTypeForceRestart,
    IBGIssueTypeOutOfMemory
};

typedef NS_ENUM(NSInteger, IBGCrashType) {
    IBGCrashTypeCrash,
    IBGCrashTypeForceRestart,
    IBGCrashTypeOOM
};

typedef NS_ENUM(NSInteger, IBGCrashReportConsent) {
    IBGCrashReportConsentAccept,
    IBGCrashReportConsentReject
};
