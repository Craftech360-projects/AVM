...
typedef NS_ENUM(NSInteger, IBGNonFatalStackTraceMode) {
    IBGNonFatalStackTraceModeFull,
    IBGNonFatalStackTraceModeCallerThread
...
/// Stack trace Mode
@property (atomic, assign) IBGNonFatalStackTraceMode stackTraceMode;
