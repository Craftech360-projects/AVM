...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/awesome_notifications_core/awesome_notifications_core.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/connectivity_plus/connectivity_plus.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/device_calendar/device_calendar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/instabug_flutter/instabug_flutter.framework"
