...
//                           Text(
//                             dateTimeFormat(
//                                 'MMM d,  yyyy', widget.memory.createdAt),
...
//                           widget.memory.startedAt == null
//                               ? dateTimeFormat(
//                                   'h:mm a', widget.memory.createdAt)
...
//                       TableRow(children: [
//                         SizedBox(
//                             height: structured.category.isNotEmpty ? 16 : 0),
//                         SizedBox(
//                             height: structured.category.isNotEmpty ? 16 : 0),
//                       ]),
...
//                   widget.memory.discarded
//                       ? const SizedBox.shrink()
//                       : _getEditTextField(overviewController, editingOverview,
//                           focusOverviewField),
//                   widget.memory.discarded
//                       ? const SizedBox.shrink()
//                       : const SizedBox(height: 40),
...
class _MemoryDetailPageState extends State<MemoryDetailPage> {
  ...
  void _createCalendarEvent(Event event) {
