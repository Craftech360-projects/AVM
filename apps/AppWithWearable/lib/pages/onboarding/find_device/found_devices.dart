// import 'dart:async';
// import 'package:AVMe/widgets/scanning_animation.dart';
...
// // Import the new ScanningAnimation widget
...
//         children: [
//           const ScanningAnimation(), // Use the new ScanningAnimation widget here
//           !_isConnected
//               ? Container(
...
//                           border: Border.all(
//                             color: const Color.fromARGB(127, 208, 208, 208),
//                             width: 1,
//                           ),
  ...
  Future<void> setBatteryPercentage(BTDeviceStruct btDevice) async {
    try {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(builder: (c) => const SpeakerIdPage(onbording: true)),
      );
    } catch (e) {
      print("Error fetching battery level: $e");
      setState(() {
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          Center(
              child:
                  ScanningAnimation()), // Centering the ScanningAnimation widget
          !_isConnected
              ? Container(
                  margin: const EdgeInsets.fromLTRB(0, 0, 4, 12),
                  child: Text(
