...
class CustomScaffold extends StatelessWidget {
  ...
  final bool primary;
  final DragStartBehavior drawerDragStartBehavior; // Correct enum
  final bool extendBody; // Corrected type
  final bool extendBodyBehindAppBar; // Corrected type
  final Color? drawerScrimColor; // Corrected type
  final double? drawerEdgeDragWidth; // Corrected type
  final bool drawerEnableOpenDragGesture; // Corrected type
  final bool endDrawerEnableOpenDragGesture; // Corrected type
  ...
  const CustomScaffold({
    ...
    this.primary = true,
    this.drawerDragStartBehavior = DragStartBehavior.start, // Correct enum
    this.extendBody = false, // Corrected type
    this.extendBodyBehindAppBar = false, // Corrected type
    this.drawerScrimColor,
    this.drawerEdgeDragWidth,
    this.drawerEnableOpenDragGesture = true, // Corrected type
    this.endDrawerEnableOpenDragGesture = true, // Corrected type
    this.restorationId,
  }) : super(key: key);
