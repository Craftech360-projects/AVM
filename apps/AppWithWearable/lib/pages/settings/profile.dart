...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //               //     size: 22.h, color: AppColors.purpleBright),
      //               CircleAvatar(
      //             backgroundColor: AppColors.greyLavender,
      ...
      //           //     size: 20, color: AppColors.blackPrimary),
      //           onTap: () {
      ...
      body: Stack(
        children: [
          ...
          Container(
            // color:
            //     const Color(0x80E6F5FA), // Optional: Semi-transparent overlay
            child: Padding(
              padding: const EdgeInsets.fromLTRB(16, 16, 4, 16),
              child: ListView(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      MixpanelManager()
                          .pageOpened('Profile Delete Account Dialog');
                      showDialog(
                          context: context,
                          builder: (ctx) {
                            return getDialog(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      MixpanelManager()
                          .pageOpened('Authorize Saving Recordings');
                      Clipboard.setData(
                          ClipboardData(text: SharedPreferencesUtil().uid));
                  ...
                  getSignOutButton(context, () {
                    ...
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (context) =>
                            const SigninPage(), // Replace with your next page widget
                      ),
                    );
                    //  routeToPage(context, const SigninPage(), replace: true);
                  }),
