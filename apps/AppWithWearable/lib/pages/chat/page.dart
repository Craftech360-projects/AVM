...
//     dynamic ragInfo =
//         await retrieveRAGContext(message, prevMessagesPluginId: pluginId);
...
//           .retrieveMostRecentMessages(limit: 10, pluginId: pluginId),
...
//           _moveListToBottom(extra: (70 * memories.length).toDouble());
//       },
//     );
//     changeLoadingState();
//   }
