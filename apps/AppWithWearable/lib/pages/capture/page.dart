...
import 'package:friend_private/utils/enums.dart';
import 'package:friend_private/utils/websockets.dart';
//import 'package:friend_private/widgets/transcript_widget.dart';
import 'package:internet_connection_checker_plus/internet_connection_checker_plus.dart';
...
class CapturePage extends StatefulWidget {
  ...
  final List<String> photos; // Assuming photos are represented by file paths
...
class _CapturePageState extends State<CapturePage> {
  ...
  Widget _buildConnectionStatus() {
    ...
    if (widget.device != null) {
      if (widget.wsConnectionState == WebsocketConnectionStatus.connected) {
        statusText = 'Connected and Capturing';
        statusColor = Colors.green;
      } else if (widget.wsConnectionState ==
  ...
  Widget _buildTranscriptList() {
    if (!widget.hasTranscripts) {
      return Center(
        child: Text('No transcripts available. Start speaking to capture.'),
      );
    }
  ...
  Widget _buildMemoryCreationStatus() {
