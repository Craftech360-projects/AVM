...
import 'package:capsoul/pages/settings/functions/firware_mixin.dart';
    ...
    try {
      ...
      for (var service in services) {
        ...
        for (var char in service.characteristics) {
          log(
              "Characteristic UUID: ${char.uuid}"); // Log characteristic UUIDs
        }
      }
                ...
                onPressed: () async {
                  if (buttonText == "Check for Updates") {
                    ...
                    try {
                      ...
                      avmSnackBar(context, "Failed to install firmware! Please try again");
                    }
                  }
                },
