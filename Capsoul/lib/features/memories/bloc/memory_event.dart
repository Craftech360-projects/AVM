...
class BatchDeleteMemory extends MemoryEvent {
...
class UpdatedSelection extends MemoryEvent {
  final List<bool> selectedMemories;

  const UpdatedSelection(this.selectedMemories);

  @override
  List<Object> get props => [selectedMemories];
}
